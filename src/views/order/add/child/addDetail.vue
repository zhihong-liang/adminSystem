...
const dialogProps = reactive<CnPage.DialogProps>({
  ...
  formProps: {
      ...
      items: [
        ...
        { label: '安装设备台数', prop: 'userNoe', component: 'input', visible: () =>  addType.value === 'az' },
        {
          label: '设备编号',
          prop: 'userNo1',
          component: 'select',
        ...
        { label: '预约上门服务时间', prop: 'userNo4', component: 'select', visible: () =>  addType.value !== 'sj' },
        { label: '选择区域', prop: 'userNo4', component: 'select', visible: () =>  addType.value === 'az' },
      ],
      colSpan: 24,
      rules: {
